	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'marquee-images': 'marquee-images 15s linear infinite',
				'marquee-images-reverse': 'marquee-images-reverse 30s linear infinite',
				...
				'morphing': 'morphing 1.5s cubic-bezier(0.4, 0, 0.2, 1) forwards',
